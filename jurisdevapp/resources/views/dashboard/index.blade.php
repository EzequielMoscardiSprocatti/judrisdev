                    ...
                    <div class="card">
                        <div class="card-header p-3 pt-2">
                            ...
                            <div class="text-end pt-1">
                                <p class="text-sm mb-0 text-capitalize">Processos Cadastrados</p>
                                <h4 class="mb-0">0</h4>
                            </div>
                        </div>
                        <hr class="dark horizontal my-0">
                       <div class="card-footer p-3">
                             <!--<p class="mb-0"><span class="text-success text-sm font-weight-bolder">+55% </span>Aumento da última semana</p>-->
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                    <div class="card">
                        <div class="card-header p-3 pt-2">
                            ...
                            <div class="text-end pt-1">
                                <p class="text-sm mb-0 text-capitalize">Colaboradores</p>
                                <h4 class="mb-0">10 </h4>
                            </div>
                        </div>
                        <hr class="dark horizontal my-0">
                ...
                <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                    <div class="card">
                        <div class="card-header p-3 pt-2">
                            ...
                            <div class="text-end pt-1">
                                <p class="text-sm mb-0 text-capitalize">Audiências Mês</p>
                                <h4 class="mb-0">20</h4>
                            </div>
                        </div>
                        <hr class="dark horizontal my-0">
                ...
                <div class="col-xl-3 col-sm-6">
                    <div class="card">
                        <div class="card-header p-3 pt-2">
                            ...
                            <div class="text-end pt-1">
                                <p class="text-sm mb-0 text-capitalize">Honorários</p>
